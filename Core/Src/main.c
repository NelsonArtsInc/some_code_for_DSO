...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, DB2_Pin|EXTERN_LED_Pin|DB6_Pin|DB7_Pin
  ...
  /*Configure GPIO pins : DB0_Pin DB1_Pin DB3_Pin */
  GPIO_InitStruct.Pin = DB0_Pin|DB1_Pin|DB3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : DB2_Pin EXTERN_LED_Pin DB6_Pin DB7_Pin
                           LCD_nRESET_Pin */
  GPIO_InitStruct.Pin = DB2_Pin|EXTERN_LED_Pin|DB6_Pin|DB7_Pin
                          |LCD_nRESET_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : DB9_Pin DB8_Pin */
  GPIO_InitStruct.Pin = DB9_Pin|DB8_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
